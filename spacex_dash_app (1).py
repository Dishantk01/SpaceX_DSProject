...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',   options=[
                                                    ...
                                                    {'label': 'CCAFS SLC-40', 'value': 'CCAFS SLC-40'}],placeholder='Select a Launch Site here',value='ALL',searchable=True),
                                html.Br(),
...
def get_scatter_plot(entered_site,entered_mass):
    if entered_site == 'ALL':
        new_df = spacex_df
        new_df2 = new_df[new_df["Payload Mass (kg)"] >= entered_mass[0]]
        new_df3 = new_df2[new_df["Payload Mass (kg)"] <= entered_mass[1]]
